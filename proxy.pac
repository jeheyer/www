function FindProxyForURL(url, host)
{
    ...
    // Hightail Stuff
    if (dnsDomainIs(host, ".hightail.com") || dnsDomainIs(host, ".dropbox.com") || dnsDomainIs(host, ".dropboxstatic.com") || dnsDomainIs(host, ".dropboxcaptcha.com") || dnsDomainIs(host ".dropboxexperiment.com"))
        return "PROXY " + Proxy + ";"; 
